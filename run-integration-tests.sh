...
export TENDERMINT_RPC_PORT=$(./find-free-port.sh)
export CLIENT_RPC_PORT=$(./find-free-port.sh)
export TENDERMINT_ZEROFEE_RPC_PORT=$(./find-free-port.sh)
export CLIENT_RPC_ZEROFEE_PORT=$(./find-free-port.sh)
